...
const FISH_DB = [
    ...
    { name: 'Язь', emoji: '🐟', minSize: 15, season: 'Апрель — Октябрь', months: [3,4,5,6,7,8,9], tackle: ['Поплавочная удочка', 'Фидер', 'Спиннинг'], bait: ['Червь', 'Мотыль', 'Кукуруза', 'Тесто'], desc: 'Осторожная рыба. Держится на средней глубине.', color: '#7a8a7a', stripes: false, waterTemp: '12-22', depth: '2-5м', habitat: 'Средняя глубина, русло', img: 'assets/fish/язь.jpg' },
    ...
    { name: 'Линь', emoji: '🐟', minSize: 15, season: 'Июнь — Сентябрь', months: [5,6,7,8], tackle: ['Поплавочная удочка', 'Донка'], bait: ['Тесто', 'Горох', 'Кукуруза', 'Червь'], desc: 'Любит теплую, тихую воду. Заросли камыша, заливы.', color: '#8a9a3a', stripes: false, waterTemp: '18-28', depth: '1-2м', habitat: 'Заросли, заливы', img: 'assets/fish/линь.jpg' },
    ...
    { name: 'Амур', emoji: '🐟', minSize: 25, season: 'Июнь — Сентябрь', months: [5,6,7,8], tackle: ['Поплавочная удочка', 'Донка'], bait: ['Кукуруза', 'Горох', 'Бамбук', 'Тесто'], desc: 'Травоядный. Держится в камышовых зарослях.', color: '#6a8a6a', stripes: false, waterTemp: '20-30', depth: '1-3м', habitat: 'Камыши, заросли', img: 'assets/fish/амур.jpg' },
