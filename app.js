...
const FISH_DB = [
    ...
    { name: 'Карп', emoji: '🐟', minSize: 15, season: 'Май — Сентябрь', months: [4,5,6,7,8], tackle: ['Поплавочная удочка', 'Фидер', 'Донка'], bait: ['Кукуруза', 'Горох', 'Тесто', 'Бойлы', 'Червь'], desc: 'Крупная, осторожная рыба. Предпочитает тёплые воды.', color: '#c4a032', stripes: false, waterTemp: '18-28', depth: '2-6м', habitat: 'Тёплые воды, ямы', img: 'assets/fish/карп.jpg' },
